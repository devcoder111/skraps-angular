...
@Component({
  selector: 'app-crypto-distributions-listing',
  templateUrl: './crypto-distributions-listing.component.html',
  styleUrls: ['./crypto-distributions-listing.component.scss'],
  changeDetection: ChangeDetectionStrategy.OnPush
})
export class CryptoDistributionsListingComponent implements OnInit {

  @Input() items;
  shadow: boolean = true;
  // displayedColumns: string[] = ['User Name', 'Coin', 'Amount', 'Status', 'Created On', 'Action'];
  displayedColumns: string[] = ['User Name', 'Coin', 'Value', 'Hash', 'Created On'];
