...
export const routes: Routes = [
  {
    ...
    children: [
      ...
      },
      {
        ...
        component: InvestmentTransactionsContainerComponent,
        data: { title: 'Investment Transactions' },
      },
      {
        path: 'investment-pools',
        component: InvestmentPoolsContainerComponent,
        data: { title: 'Investment Pools' },
      },
      {
        path: 'pending-investment',
        component: PendingTransactionsContainerComponent,
