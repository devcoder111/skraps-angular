...
import { InvestmentTransactionsContainerComponent } from './containers/investment-transactions-container/investment-transactions-container.component';
import { InvestmentPoolsContainerComponent } from './containers/investment-pools-container/investment-pools-container.component';
import { InvestmentPoolsComponent } from './components/investment-pools/investment-pools.component';
import { InvestmentTransactionsComponent } from './components/investment-transactions/investment-transactions.component';
import { PendingTransactionsComponent } from './components/pending-transactions/pending-transactions.component';
import { PendingTransactionsContainerComponent } from './containers/pending-transactions-container/pending-transactions-container.component';
...
@NgModule({
  ...
  declarations: [
    ...
    WalletComponent,
    InvestmentTransactionsContainerComponent,
    InvestmentPoolsContainerComponent,
    InvestmentPoolsComponent,
    InvestmentTransactionsComponent,
    PendingTransactionsComponent,
    PendingTransactionsContainerComponent,
  ],
  entryComponents: [
    SnackBarComponent,
    ChangePasswordSettingsComponent,
