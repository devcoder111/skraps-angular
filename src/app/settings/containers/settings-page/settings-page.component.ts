...
export class SettingsPageComponent implements OnInit, OnDestroy {
  public menuLinks: Array<IMenuItem> = [
    ...
    { link: '/settings/investment-transactions', hint: 'Investment transactions' },
    { link: '/settings/investment-pools', hint: 'Investment Pools' },
    { link: '/settings/pending-investment', hint: 'Pending transactions' },
